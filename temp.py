...
mapbox_access_token = "pk.eyJ1IjoiY2FjcDMwMDkiLCJhIjoiY2w0NjRxYW1nMDUxbjNicGJ0YzhkM2k4ZCJ9.qvEmFfPwefs9IRi0mX5o4A"

# Dictionary of important locations in New York
list_of_locations = {

    "Atlantico": {"lat": 10.963889, "lon": -74.796387},
    "Antioquia": {"lat": 6.230833, "lon": -75.590553},
   
}
dfx = pd.read_csv("data/AGROSAVIA.csv")
print(dfx.columns)
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.H2("Soil analysis for crops in Colombia"),
                        html.P(
                                ...
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        dcc.Dropdown(
                                            ...
                                            options=[
                                                {
                                                    "label": str(dfx.columns[n]) ,
                                                    "value": str(n),
                                                }
                                                for n in range(len(dfx.columns))
                                            ],
                                            multi=True,
                                            placeholder="Select certain Variable",
                                        )
                                    ],
                                ),
                            ],
                        ...
                        [
                            dict(
                                args=[
                                    {
                                        "mapbox.zoom": 4.0,
                                        "mapbox.center.lon": "4.624335",
                                        "mapbox.center.lat": "-74.063644",
                                        "mapbox.bearing": 0,
                                        "mapbox.style": "dark",
                                    }
                                ],
